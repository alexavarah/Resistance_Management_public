...
panel_wd_gp_bw_1col <- (plot_wd + plot_gp) + 
  plot_layout(ncol=1) +
...
### 4.2.2. Specify plot  
```{r Fig4a-plot-scatter-worstcase-oc-bw}
...
# 8. SI: Sensitivity analysis plots
